...
const OrderCard = ({ order, tableId }: Props) => {
  ...
  return (
    <div onDoubleClick={handleUpdateOrder} className={`w-full ${order.status === 'P' && 'bg-transparent border-2'} ${order.status === 'S' && 'bg-blue-700'} flex flex-col justify-center items-center p-6 gap-6 rounded-3xl my-6 text-slate-200`}>
