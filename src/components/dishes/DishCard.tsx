...
const DishCard = ({ dish }: Props) => {
  ...
  return (
    <motion.li 
        ...
        className={`mx-auto max-w-[1280px] max-lg:w-[360px] w-full flex flex-col justify-center items-center text-center gap-8 cursor-pointer ${!dish.available && 'line-through decoration-red-500 decoration-4'}`}>
